...
func (c *authClient) Login(ctx context.Context, in *Credentials, opts ...grpc.CallOption) (*LoginResponse, error) {
...
func (UnimplementedAuthServer) Login(context.Context, *Credentials) (*LoginResponse, error) {
