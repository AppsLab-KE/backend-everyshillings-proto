...
var file_otp_server_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0xc2, 0x01, 0x0a, 0x0a, 0x4f, 0x74, 0x70, 0x53,
	...
	0x72, 0x69, 0x66, 0x79, 0x4f, 0x54, 0x50, 0x52, 0x65, 0x73, 0x22, 0x00, 0x42, 0x32, 0x5a, 0x30,
...
var file_otp_server_proto_goTypes = []interface{}{
	...
	(*CreateAndSendOtpRes)(nil), // 5: otp.CreateAndSendOtpRes
	(*VerifyOTPRes)(nil),        // 6: otp.VerifyOTPRes
}
var file_otp_server_proto_depIdxs = []int32{
	...
	1, // 3: otp.OtpService.HealthCheck:output_type -> otp.HealthResponse
	5, // 4: otp.OtpService.CreateAndSendOtp:output_type -> otp.CreateAndSendOtpRes
	6, // 5: otp.OtpService.VerifyOtp:output_type -> otp.VerifyOTPRes
